...
load("./Step2.Pseudobulk.Rdata")

# reading in the protein data
protein_normalized <- read_csv("../protein_normalized.csv")
...
Log_n = readRDS("/mnt/data1/elyas/Single-cell/Pseudo_bulk-proteomics/All44-sets/Log_n.rds");
...
protein.table <- readRDS( "/mnt/data1/elyas/Single-cell/Pseudo_bulk-proteomics/protein.table.rds");
...
getwd()
setwd("../Pseudo_bulk-proteomics/Pics/")
